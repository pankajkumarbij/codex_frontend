      ...
      <nav className="bg-white px-2 sm:px-4 py-1 w-full z-20 top-0 left-0 border-b border-gray-200 shadow">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className="flex md:order-2">
            ...
            {!isLogin ?
              <div className="flex">
                <button type="button" onClick={()=>setIsLogin(true)} className="text-blue-700 hover:text-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center mr-0 md:mr-2">Log in</button>
                <button type="button" onClick={()=>setIsLogin(true)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center mr-0 md:mr-0 hidden md:block">Get started</button>
              </div>
            :
